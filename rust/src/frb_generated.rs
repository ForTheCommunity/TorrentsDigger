...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -722546024;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__app__dig_torrent_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__app__fetch_source_details_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__database__get_settings_kv__get_active_default_trackers_list_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__crate__api__database__bookmark__get_all_bookmarks_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        9 => wire__crate__api__app__get_all_default_trackers_list_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        11 => wire__crate__api__app__get_ip_details_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__database__proxy__get_saved_proxy_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__database__get_settings_kv__get_settings_kv_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__database__proxy__get_supported_proxy_details_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__database__initialize__initialize_torrents_digger_database_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__database__bookmark__remove_bookmark_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__crate__api__database__proxy__save_proxy_api_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__crate__api__database__get_settings_kv__set_default_trackers_list_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
